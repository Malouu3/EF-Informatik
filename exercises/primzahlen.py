...
for nummer in range(1, 1001):           # läuft alle Zahlen von 1 - 101 ab und setzt sie in die Variable "nummer"
    if nummer > 1:                     # Wenn "nummer" grösser als 1 ist:
        for i in range(2, nummer):      # dann wird die nummer durch die variable "i" geteilt, die von null bis
            ...
            primzahlen.append(nummer)   #Setzt die Zahl in die Liste Primzahlen
