...
def index_zeile(n):                 #Gibt die Spaltenzahlen an
    print('   ', end='')            #n ist die Menge an Zeilen
    for i in range(n):
        print(f' {i + 1} ', end='')
    print('')

def strich_horizontal(n):           #Deffiniert den obersten Strich
    print('  ', end='')
    for i in range(n):
        print('---', end='')
    print('-')
...
def print_zeile(zeile_nr):              # print_zeile(len(board))
